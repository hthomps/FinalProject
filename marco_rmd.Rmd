...
goi1.x<-predict(db.nt, msex.prot.goi[1])
goi1.x[1:5,]

goi2.x<-predict(db.nt, msex.prot.goi[2])
goi2.x[1:5,]

goi3.x<-predict(db.nt, msex.prot.goi[3])
goi3.x[1:5,]

goi4.x<-predict(db.nt, msex.prot.goi[4])
goi4.x[1:5,]

goi5.x<-predict(db.nt, msex.prot.goi[5])
goi5.x[1:5,]

goi6.x<-predict(db.nt, msex.prot.goi[6])
goi6.x[1:5,]
```
